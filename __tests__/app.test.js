    ...
    describe('GET', () => {
        it("200: GET all articles", () => {
          ...
          it("200: return status code 200, SORT data by the requested query", () => {
            return supertest(app).get("/api/articles?sort_by=article_id").expect(200)
              .then((res) => {
                const { articles } = res.body;
                expect(articles.length).toBe(13)
          ...
          it("400: return status code 400, SORT query Bad Request (invalid query)", () => {
            return supertest(app).get("/api/articles?sort_by=abcabc").expect(400)
              .then((res) => {
                const { msg } = res.body;
          ...
          it("200: return status code 200, ORDER data by the requested query", () => {
            return supertest(app).get("/api/articles?order=asc").expect(200)
              .then((res) => {
                const { articles } = res.body;
                expect(articles.length).toBe(13)
          ...
          it("200: return status code 200, ORDER data by the requested query", () => {
            return supertest(app).get("/api/articles?order=desc").expect(200)
              .then((res) => {
                const { articles } = res.body;
                expect(articles.length).toBe(13)
                expect(articles).toBeSortedBy("created_at", {descending: true});
          ...
          it("400: return status code 400, ORDER query Bad Request (invalid query)", () => {
            return supertest(app).get("/api/articles?order=abcabc").expect(400)
              .then((res) => {
                const { msg } = res.body;
                expect(msg).toBe('Bad Request')
              });
          ...
          it("200: return status code 200, combining both SORT and ORDER queries", () => {
            return supertest(app).get("/api/articles?sort_by=article_id&order=asc").expect(200)
              .then((res) => {
                const { articles } = res.body;
                expect(articles.length).toBe(13)
